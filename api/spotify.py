...
'''
    ...
    6. AUDIO FEATURES: https://developer.spotify.com/documentation/web-api/reference/tracks/get-audio-features/
...
GET_AUDIO_FEATURES = "{}/{}".format(SPOTIFY_API_URL, 'audio-features')

# https://developer.spotify.com/documentation/web-api/reference/tracks/get-audio-features/
def get_audio_feature(track_id):
    url = "{}/{id}".format(GET_AUDIO_FEATURES, id=track_id)
    resp = requests.get(url)
    return resp.json()
